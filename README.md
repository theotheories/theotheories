...
| Project | Description |
|---------|-------------|
| **[Amazon Style eCommerce Website](https://clone-1801d.web.app/)** <br> <img src="./images/amazon.png" alt="Amazon Full Stack Clone" width="200"/> | A fully functional e-commerce website built with **React.js**, **Stripe**, and **Firebase** for full-stack operations. |
| **[API and Frontend - Spotify Style](https://theospotifyclone.web.app/)** <br> <img src="./images/spotify.png" alt="Spotify Clone" width="200"/> | Built a Spotify clone using **React.js**, **Spotify API**, and **Firebase**. Features real-time playlist display and slick UI. |
